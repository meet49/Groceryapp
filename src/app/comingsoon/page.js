    ...
    return (
        ...
        <div className="flex">
            <div className="bg-white bg-[url('../app/assets/img/bg6.png')] h-[1080px] w-[50%] flex flex-col  justify-center pl-32">
                ...
                <p className="w-[478px] text-[#EF682E] font-bold text-4xl pb-5">All Good Things Come to Those who Wait...</p>
                <p className="text-base w-[495px] pb-10">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC Lorem Ipsum.</p>
                <div className="pb-10">
                    <p className="text-sm pb-2">
                        Notify Me
                    </p>
                    <div className="w-[519px] flex justify-between">
                        <input type="email" placeholder="Enter Your Email" className=" border-[#ffbfa3] border h-[60px] w-[380px] rounded-md p-2" />
                        <button className="p-2 h-[60px] w-[109px] border bg-[#609E45] text-white rounded-md font-poppins font-semibold text-base">Submit</button>
                    </div>
                </div>
            ...
            <div  className="bg-gray-100  w-[50%]">
                <Image src={user} width={"746"} className="p-24 mt-64 ml-32"/>
            </div>
        </div>
    )
}
