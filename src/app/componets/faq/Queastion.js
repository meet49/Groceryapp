            ...
            <div className="bg-white">
                <div className="flex gap-5 justify-center">
                    <div className="flex flex-col gap-5 mt-5">
                        <h1 className="text-xl font-bold text-[#609E45] pt-3 pl-5 w-[635px] h-[62px] border border-[#EF682E33]">Pre-Sale Questions</h1>
                        <div className="flex flex-col w-[635px] rounded-md ">
                            <div className="flex justify-between w-[635px] pl-5 h-[62px] border border-[#EF682E33]" onClick={toggleText1} style={{ backgroundColor: showText1 ? '#609E45' : 'white', color: showText1 ? 'white' : 'black' }}>
                                <button>How do I Claim a Free Coupon?</button>
                                <Image src={drop} className="w-[23.14px] h-6 mt-4 mr-5" />
                            </div>
                        ...
                        <div className="flex flex-col w-[635px]">
                            <div className="flex justify-between w-[635px] pl-5 h-[62px] border border-[#EF682E33]" onClick={toggleText2} style={{ backgroundColor: showText2 ? '#609E45' : 'white', color: showText2 ? 'white' : 'black' }}>
                        ...
                        <div className="flex flex-col w-[635px]">
                            <div className="flex justify-between w-[635px] pl-5 h-[62px] border border-[#EF682E33]" onClick={toggleText3} style={{ backgroundColor: showText3 ? '#609E45' : 'white', color: showText3 ? 'white' : 'black' }}>
                        ...
                        <div className="flex flex-col w-[635px]">
                            <div className="flex justify-between w-[635px] pl-5 h-[62px] border border-[#EF682E33]" onClick={toggleText4} style={{ backgroundColor: showText4 ? '#609E45' : 'white', color: showText4 ? 'white' : 'black' }}>
                    ...
                    <div className="flex flex-col gap-5 mt-5">
                        <h1 className="text-xl font-bold pl-5 pt-3 text-[#609E45] w-[635px] h-[62px] border border-[#EF682E33]">Delivery Quistions</h1>
                        <div className="flex flex-col w-[635px]">
                            <div className="flex justify-between w-[635px] pl-5 h-[62px] border border-[#EF682E33]" onClick={toggleText6} style={{ backgroundColor: showText6 ? '#609E45' : 'white', color: showText6 ? 'white' : 'black' }}>
                                <button>How do I Claim a Free Coupon?</button>
                                <Image src={drop} className="w-[23.14px] h-6 mt-4 mr-5" />
                            </div>
                        ...
                        <div className="flex flex-col w-[635px]">
                            <div className="flex justify-between w-[635px] pl-5 h-[62px] border border-[#EF682E33]" onClick={toggleText7} style={{ backgroundColor: showText7 ? '#609E45' : 'white', color: showText7 ? 'white' : 'black' }}>
                                <button>How do I Make a regular Table Booking?</button>
                                <Image src={drop} className="w-[23.14px] h-6 mt-4 mr-5" />
                            </div>
                        ...
                        <div className="flex flex-col w-[635px]">
                            <div className="flex justify-between w-[635px] pl-5 h-[62px] border border-[#EF682E33]" onClick={toggleText8} style={{ backgroundColor: showText8 ? '#609E45' : 'white', color: showText8 ? 'white' : 'black' }}>
                                <button>How can I be certain my booking's been received?</button>
                                <Image src={drop} className="w-[23.14px] h-6 mt-4 mr-5" />
                            </div>
                        ...
                        <div className="flex flex-col w-[635px]">
                            <div className="flex justify-between w-[635px] pl-5 h-[62px] border border-[#EF682E33]" onClick={toggleText9} style={{ backgroundColor: showText9 ? '#609E45' : 'white', color: showText9 ? 'white' : 'black' }}>
                                <button>What happens if I'm running late?</button>
                                <Image src={drop} className="w-[23.14px] h-6 mt-4 mr-5" />
                            </div>
                ...
                <div className="flex gap-5 justify-center pb-5">
                    <div className="flex flex-col gap-5 mt-10">
                        <h1 className="text-xl font-bold pl-5 pt-3 text-[#609E45] w-[635px] h-[62px] border border-[#EF682E33]">Pricing Questions</h1>
                        <div className="flex flex-col w-[635px]">
                            <div className="flex justify-between w-[635px] pl-5 h-[62px] border border-[#EF682E33]" onClick={toggleText11} style={{ backgroundColor: showText11 ? '#609E45' : 'white', color: showText11 ? 'white' : 'black' }}>
                                <button>How do I Claim a Free Coupon?</button>
                                <Image src={drop} className="w-[23.14px] h-6 mt-4 mr-5" />
                            </div>
                        ...
                        <div className="flex flex-col w-[635px]">
                            <div className="flex justify-between w-[635px] pl-5 h-[62px] border border-[#EF682E33]" onClick={toggleText12} style={{ backgroundColor: showText12 ? '#609E45' : 'white', color: showText12 ? 'white' : 'black' }}>
                                <button>How do I Make a regular Table Booking?</button>
                                <Image src={drop} className="w-[23.14px] h-6 mt-4 mr-5" />
                            </div>
                        ...
                        <div className="flex flex-col w-[635px]">
                            <div className="flex justify-between w-[635px] pl-5 h-[62px] border border-[#EF682E33]" onClick={toggleText13} style={{ backgroundColor: showText13 ? '#609E45' : 'white', color: showText13 ? 'white' : 'black' }}>
                                <button>How can I be certain my booking's been received?</button>
                                <Image src={drop} className="w-[23.14px] h-6 mt-4 mr-5" />
                            </div>
                        ...
                        <div className="flex flex-col w-[635px]">
                            <div className="flex justify-between w-[635px] pl-5 h-[62px] border border-[#EF682E33]" onClick={toggleText14} style={{ backgroundColor: showText14 ? '#609E45' : 'white', color: showText14 ? 'white' : 'black' }}>
                                <button>What happens if I'm running late?</button>
                                <Image src={drop} className="w-[23.14px] h-6 mt-4 mr-5" />
                            </div>
                    ...
                    <div className="flex flex-col gap-5 mt-10">
                        <h1 className="text-xl font-bold pl-5 pt-3 text-[#609E45] w-[635px] h-[62px] border border-[#EF682E33]">My Account Quistions</h1>
                        <div className="flex flex-col w-[635px]">
                            <div className="flex justify-between w-[635px] pl-5 h-[62px] border border-[#EF682E33]" onClick={toggleText16} style={{ backgroundColor: showText16 ? '#609E45' : 'white', color: showText16 ? 'white' : 'black' }}>
                                <button>How do I Claim a Free Coupon?</button>
                                <Image src={drop} className="w-[23.14px] h-6 mt-4 mr-5" />
                            </div>
                        ...
                        <div className="flex flex-col w-[635px]">
                            <div className="flex justify-between w-[635px] pl-5 h-[62px] border border-[#EF682E33]" onClick={toggleText17} style={{ backgroundColor: showText17 ? '#609E45' : 'white', color: showText17 ? 'white' : 'black' }}>
                                <button>How do I Make a regular Table Booking?</button>
                                <Image src={drop} className="w-[23.14px] h-6 mt-4 mr-5" />
                            </div>
                        ...
                        <div className="flex flex-col w-[635px]">
                            <div className="flex justify-between w-[635px] pl-5 h-[62px] border border-[#EF682E33]" onClick={toggleText18} style={{ backgroundColor: showText18 ? '#609E45' : 'white', color: showText18 ? 'white' : 'black' }}>
                                <button>How can I be certain my booking's been received?</button>
                                <Image src={drop} className="w-[23.14px] h-6 mt-4 mr-5" />
                            </div>
                        ...
                        <div className="flex flex-col w-[635px]">
                            <div className="flex justify-between w-[635px] pl-5 h-[62px] border border-[#EF682E33]" onClick={toggleText19} style={{ backgroundColor: showText19 ? '#609E45' : 'white', color: showText19 ? 'white' : 'black' }}>
                                <button>What happens if I'm running late?</button>
                                <Image src={drop} className="w-[23.14px] h-6 mt-4 mr-5" />
                            </div>
