    ...
    <div>
      <div className="relative">
          <div className="bg-gray-100 flex items-center justify-center gap-10 pt-[450px]">
            <div>
              <p className="mb-8 font-bold text-2xl">Top Sells<p className="text-[#EF682E]">_____</p></p>
            ...
            <div>
              <p className="mb-8 font-bold text-2xl">Recently Added<p className="text-[#EF682E]">_____</p></p>
              <div className="flex gap-1 mb-8">
            ...
            <div>
              <p className="mb-8 font-bold text-2xl">Top Rated<p className="text-[#EF682E]">_____</p></p>
              <div className="flex gap-1 mb-8">
