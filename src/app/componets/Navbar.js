    ...
    return (
        <>
            <div className="flex justify-around py-1">
                <div>
                    <p className="font-poppins text-white text-[14px]">Welcome to the best TRoo Organic Grocery Store</p>
                </div>
                <div>
                    <p className="font-poppins text-white text-[14px]"><b>50% </b>Clearance Sale</p>
                </div>
            ...
            <div className="bg-white mx-1 py-5 px-20 flex justify-between h-[82px]">
                ...
                <div className="input-border ml-28">
                    <input type="text" placeholder="Search Your Products" className="w-[500px] p-3" />
