      ...
      <div className="bg-white py-24">
          <div className="h-[1235px]  flex flex-col justify-between self-center items-center">
            ...
            <div className="flex  justify-center items-center">
              ...
              <button className="w-[150px] h-[50px] rounded-md bg-[#ef682e23] text-black mr-1">Best Sellers</button>
              <button className="w-[150px] h-[50px] rounded-md bg-[#ef682e23] text-black mr-1">New Arrivals</button>
              <button className="w-[150px] h-[50px] rounded-md bg-[#ef682e23] text-black mr-1">Top Rated</button>
            </div>
            <div className="flex justify-center gap-6">
              <div className="h-[463px]   border-[1px] border-[#609E45] relative">
              ...
              <div className="h-[463px] border-[1px] border-[#EF682E33]">
