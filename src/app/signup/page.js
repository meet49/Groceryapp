        ...
        <div className="bg-[url('../app/assets/img/bg12.png')] bg-no-repeat bg-white  py-20">
            <div className="flex justify-center">
                <div className="bg-[url('../app/assets/img/bg14.png')] bg-no-repeat w-[615px] h-[803px]">
                    <div className="p-10">
                        <div className="flex gap-3 bg-white w-[256px] h-[80px] rounded-md justify-center items-center">
                ...
                <div>
                    <div className="w-[685px] h-[803px] bg-white flex flex-col gap-5 p-10 rounded-md">
                        ...
                        <div className="flex flex-col  gap-6">
                            ...
                            <button className="w-[585px] h-[60px] bg-[#609E45] text-white rounded-md font-semibold text-xl">Sign Up Now</button>
